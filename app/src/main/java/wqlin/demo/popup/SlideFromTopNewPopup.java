...
import wqlin.demo.utils.DimensUtils;

/**
 * Created by wqlin on 2016/12/6.
 * <p>
 * 从部下滑的Poup
 */

public class SlideFromTopNewPopup extends BasePopupWindow {

    private List<String> testList;

    public SlideFromTopNewPopup(Activity context) {
