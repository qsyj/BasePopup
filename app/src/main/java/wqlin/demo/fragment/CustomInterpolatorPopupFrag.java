...
import wqlin.demo.interpolator.CustomInterpolatorFactory;
import wqlin.demo.popup.CustomInterpolatorPopup;

/**
 * Created by wqlin on 2016/1/28.
 * 各种插值器
 */
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.jelly:
                ...
                mInterpolatorPopup.show(null, LocationType.CENTER_CENTER);
                break;
            case R.id.anti:
